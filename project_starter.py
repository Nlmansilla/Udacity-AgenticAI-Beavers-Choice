...
orchestrator_agent = Agent(
    ...
    instructions=(
        ...
        "An exact catalog product name, quantity, and catalog sales unit are "
        "sufficient for a quote or inventory request. Do not ask for optional "
        "size, weight, color, or finish details when the customer requests an "
        "exact catalog item without those specifications. "
