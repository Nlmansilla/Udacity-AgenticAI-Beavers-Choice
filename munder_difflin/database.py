"""Database engine and read/write helpers used by the business tools."""
...
def configure_database_engine(engine: Engine) -> None:
    """Set the engine used by database helpers and transaction tools."""
    global db_engine
    db_engine = engine


def get_database_engine() -> Engine:
    """Return the currently configured database engine."""
    return db_engine
